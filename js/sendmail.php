...
$sendto = 'contato@laboratoriobiolab.com';

// The subject you'll see in your inbox
$subject = 'Messagem enviada via Fale Conosco - SITE';

// Message for the user when he/she doesn't fill in the form correctly.
$errormessage = 'Parece que você está faltando alguma informação. Tente novamente.&nbsp;';

//Message for the user when he/she fills in the form correctly.
$thanks = "Obrigado pelo email. Retornaremos a você assim que pudermos.&nbsp;";

// Message for the bot when it fills in in at all.
$honeypot = "Você completou o honeypot! Se você é humano, tente novamente!&nbsp;";

// Various messages displayed when the fields are empty.
$emptyname =  'Digite o Nome?&nbsp;';
$emptyphone = 'Digite o Telefone?&nbsp;';
$emptyemail = 'Digite o Email?&nbsp;';
$emptymessage = 'Digite a mensagem?&nbsp;';

// Various messages displayed when the fields are incorrectly formatted.
$alertname =  'Digite seu nome usando apenas o alfabeto padrão?&nbsp;';
$alertphone =  'Digite seu número de telefone usando apenas os caracteres padrão?&nbsp;';
$alertemail = 'Digite seu e-mail no formato válido Ex.: <i>name@example.com</i>?&nbsp;';
$alertmessage = "Certifique-se de que você não está usando parênteses ou outros caracteres que escapam na mensagem? &nbsp;";
